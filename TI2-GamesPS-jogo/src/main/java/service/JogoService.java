...
public class JogoService {
	...
	public void makeForm(int tipo, Jogo jogo,int orderby) {
		...
		if(tipo == FORM_INSERT) {
			...
			umJogo += "\t<form class=\"form--register\" action=\"" + action + "\" method=\"post\" id=\"form-add\">";
			umJogo += "        <tr>\r\n";
			umJogo += "        <td colspan=\"3\" align=\"left\" id=\"title\"><font size=\"+2\"><b>UPDATE DE JOGOS</b></font></td>\r\n";
			umJogo += "        </tr>\r\n";
			umJogo += "        <tr>\r\n";
			umJogo += "        <td colspan=\"3\" align=\"left\"></td>\r\n";
			umJogo += "        </tr>\r\n";
			umJogo += "        <tr>\r\n";
			umJogo += "        <td>Id: <input class=\"input--register\" type=\"text\" name=\"id\"></td>\r\n";
			umJogo += "        <td>Nome: <input class=\"input--register\" type=\"text\" name=\"nome\"></td>\r\n";
			umJogo += "        <td>Categorias: <input class=\"input--register\" type=\"text\" name=\"categorias\" ></td>\r\n";
			umJogo += "        <td>Empresa: <input class=\"input--register\" type=\"text\" name=\"empresa\" ></td>\r\n";
			umJogo += "        <td>Descrição: <input class=\"input--register\" type=\"text\" name=\"descricao\"></td>\r\n";
			...
			umJogo += "\t\t</tr>";
			umJogo += "\t\t<tr>";
			umJogo += "\t\t\t<td>&nbsp;Nome: "+ jogo.getDescricao() +"</td>";
			umJogo += "\t\t\t<td>Empresa: "+ jogo.getEmpresa() +"</td>";
			umJogo += "\t\t\t<td>Avaliacao: "+ jogo.getAvaliacao() +"</td>";
			umJogo += "\t\t</tr>";
			umJogo += "\t</table>";		
	...
	public Object insert(Request request, Response response) {
		...
		Jogo jogo = new Jogo(-1, nome,categorias,empresa,descricao,avaliacao,links,especificacoes);
	...
	public Object getToUpdate(Request request, Response response) {
		int id = Integer.parseInt(request.params(":id"));		
		Jogo produto = (Jogo) jogoDAO.get(id);
	...
	public Object update(Request request, Response response) {
        ...
        if (jogo != null) {
        	...
        	int[] categorias = new int[5];        	
        	for(int i = 0; i < categ.length(); i++) {categorias[i] = Integer.parseInt(conv[i]);}
